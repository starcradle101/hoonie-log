	...
	return (
		<nav className='flex shrink-0 flex-col p-2 md:h-screen'>
			...
			<div className='flex grow space-x-2 md:flex-col md:space-x-0 md:space-y-2'>
				<div className='mt-2 flex h-auto w-full flex-1 rounded-md bg-gray-50 md:mt-0 md:block'>
					<NavLinks />
				</div>

				<div className='flex items-center justify-center rounded-md bg-gray-50 hover:bg-green-100 hover:text-green-600 md:block'>
					<form>
						<button
							formAction={signout}
